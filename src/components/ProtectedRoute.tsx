      ...
      <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-xl shadow-sm p-8 max-w-md w-full text-center">
          ...
          <button
            ...
            className="w-full bg-white border border-slate-300 text-slate-700 py-3 px-4 rounded-lg hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3 mb-4"
          >
            ...
            {authLoading ? 'Menghubungkan ke Google...' : 'Login dengan Google'}
          </button>
